...
import (
	...
	cp "github.com/gardener/machine-controller-manager-provider-digitalocean/pkg/provider"
	"github.com/gardener/machine-controller-manager-provider-digitalocean/pkg/spi"
